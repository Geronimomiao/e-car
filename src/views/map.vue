<template>
  <div id="b_map">
    ...
    <baidu-map class="bm-view" :center="center" :zoom="zoom">
      ...
      <bm-marker class="my-location" :position='getPosition(this.my_location.x, this.my_location.y)' :icon="{url: 'http://wsmpage.cn/map/err_map.png', size: {width: 20, height: 20}}">
      </bm-marker>
    </baidu-map>
  </div>
</template>
